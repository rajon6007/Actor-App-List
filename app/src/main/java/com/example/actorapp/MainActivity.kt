...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero.add(Hero("Ajit Kumar","Vedalam","$14M",R.drawable.ajit))
        hero.add(Hero("NTR jr","RRR","$30M",R.drawable.ntr))
        hero.add(Hero("Naga Chaitanya","The Nagesh","$20M",R.drawable.naga))
        hero.add(Hero("Ram Charan","RRR","$14M",R.drawable.ram))
        hero.add(Hero("pawan kalyan","Ismart Shankar","$14M",R.drawable.pawan))
    ...
    private fun showHeroAddDialog(){
       ...
       AlertDialog.Builder(this)
           ...
           .setPositiveButton("Add") { _, _ ->
               ...
               hero.add(Hero(name,title,fees,img))
